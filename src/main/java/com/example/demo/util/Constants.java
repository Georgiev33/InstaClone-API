...
public class Constants {
    ...
    public static final String VIDEO_M_4_V = "video/m4v";
    public static final String UPLOADS = "uploads";
    public static final String FILE = "File ";
    public static final String WAS_SAVED_SUCCESSFULLY = " was saved successfully.";
    public static final String ERROR_WHILE_SAVING_FILE = "Error while saving file ";
